  ...
  return (
    <main className="min-h-screen bg-white pb-20 pt-10">
      <article className="container mx-auto px-4 max-w-4xl">
         {/* Breadcrumb / Back */}
         <div className="mb-8">
            <Button variant="ghost" className="text-stone-500 hover:text-orange-600 pl-0" asChild>
         ...
         <header className="mb-10 text-center">
             <Badge variant="secondary" className="bg-orange-50 text-orange-600 hover:bg-orange-100 mb-4 px-3 py-1 text-sm">
             ...
             <div className="flex items-center justify-center text-stone-500 gap-6 text-sm">
                 ...
                 <Button variant="ghost" size="sm" className="text-stone-400 hover:text-orange-500">
         ...
         {/* Content */}
         <div className="prose prose-lg max-w-none prose-stone prose-headings:font-noto-sans-tc prose-headings:font-bold prose-img:rounded-xl">
            {/* Simple whitespace rendering for now, or Markdown if we have a parser */}
            <div className="whitespace-pre-wrap font-noto-sans-tc text-stone-700 leading-loose">
                {post.content}
            </div>
         </div>
         ...
         {post.file_url && (
            <div className="mt-12 p-6 bg-stone-50 border border-stone-200 rounded-xl flex items-center justify-between">
                ...
                <Button asChild>
                    <a href={post.file_url} target="_blank" rel="noopener noreferrer">下載檔案</a>
                </Button>
            </div>
         )}
      </article>
